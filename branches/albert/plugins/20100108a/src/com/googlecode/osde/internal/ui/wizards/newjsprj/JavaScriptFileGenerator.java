...
public class JavaScriptFileGenerator {
    ...
    public JavaScriptFileGenerator(IProject project, GadgetXmlData gadgetXmlData,
    ...
    public List<IFile> generate(IProgressMonitor monitor)
    ...
    private IFile generateJavaScriptFile(IProgressMonitor monitor, ViewName viewName,
            GadgetViewData viewData) throws CoreException, UnsupportedEncodingException {
