...
public class PersonPage implements IDetailsPage {
    ...
    public void createContents(Composite parent) {
        ...
        happiestWhenText =
                createText("Happiest when:", generalPane, toolkit, generalValueChangeListener);
        humorText = createText("Humor:", generalPane, toolkit, generalValueChangeListener);
        jobInterestsText =
                createText("Job interest:", generalPane, toolkit, generalValueChangeListener);
        livingArrangementText =
                createText("Living arrangement:", generalPane, toolkit, generalValueChangeListener);
        //
        ...
        politicalViewsText =
                createText("Political views:", generalPane, toolkit, generalValueChangeListener);
        profileUrlText =
                createText("Profile URL:", generalPane, toolkit, generalValueChangeListener);
        ...
        sexualOrientationText =
                createText("Sexual orientation:", generalPane, toolkit, generalValueChangeListener);
        //
        ...
        additionalNameText =
                createText("Additional name:", namePane, toolkit, nameValueChangeListener);
        honorificPrefixText =
                createText("Honorific prefix:", namePane, toolkit, nameValueChangeListener);
        honorificSuffixText =
                createText("Honorific suffix:", namePane, toolkit, nameValueChangeListener);
        nameUnstructuredText =
                createText("Unstructured:", namePane, toolkit, nameValueChangeListener);
        //
        // Body type
        ...
        hairColorText =
                createText("Hair color:", bodyTypePane, toolkit, bodyTypeValueChangeListener);
    ...
    private Text createText(String label, Composite parent, FormToolkit toolkit,
    ...
    private class ValueChangeListener implements FocusListener, SelectionListener {
        ...
        private void updatePerson() {
            try {
                ...
                person.setDrinker(
                        StringUtils.isNotEmpty(drinker) ? new DrinkerImpl(Drinker.valueOf(drinker),
                                drinker) : null);
                String networkPresence = networkPresenceCombo.getText();
                person.setNetworkPresence(
                        StringUtils.isNotEmpty(networkPresence) ? new NetworkPresenceImpl(
                                NetworkPresence.valueOf(networkPresence), networkPresence) : null);
                String smoker = smokerCombo.getText();
                person.setSmoker(
                        StringUtils.isNotEmpty(smoker) ? new SmokerImpl(Smoker.valueOf(smoker),
                                smoker) : null);
                //
                Name name = person.getName();
                if (name == null) {
    ...
    private class AddButtonSelectionListener implements SelectionListener {
        ...
        public void widgetSelected(SelectionEvent evt) {
            try {
                ...
                AddRelationshipDialog dialog =
                        new AddRelationshipDialog(personView.getSite().getShell(), people);
                if (dialog.open() == Window.OK) {
                    ...
                    Job job = new Job("Add relationship") {
                        ...
                        protected IStatus run(IProgressMonitor monitor) {
                            ...
                            final RelationshipImpl relation =
