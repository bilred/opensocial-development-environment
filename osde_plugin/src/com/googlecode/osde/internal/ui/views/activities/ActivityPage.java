...
import static com.googlecode.osde.internal.utils.Gadgets.stringFromTimeMillis;
...
public class ActivityPage implements IDetailsPage {
    ...
    public void createContents(Composite parent) {
        ...
        //
        Table table = toolkit.createTable(mediaItemsPane,
        ...
        //
        Section templateParamsSection =
                toolkit.createSection(parent, ExpandableComposite.TITLE_BAR);
        ...
        //
        table = toolkit.createTable(templateParamsPane,
                SWT.SINGLE | SWT.H_SCROLL | SWT.V_SCROLL | SWT.FULL_SELECTION | SWT.BORDER);
        table.setHeaderVisible(true);
        table.setLinesVisible(true);
        layoutData = new GridData(GridData.FILL_BOTH);
