...
public class PersonServiceImplTest extends AbstractServiceTest {
	...
	public void testGetPerson() throws Exception {
		...
		session.clear();
		//
		SecurityToken token = new BasicSecurityToken("id1", null, null, null, null, null);
	...
	public void testIsViewerOwner() throws Exception {
		...
		session.clear();
		//
		SecurityToken token = new BasicSecurityToken("id1", "id1", null, null, null, null);
		...
		//
		token = new BasicSecurityToken("id2", "id2", null, null, null, null);
	...
	public void testGetIdSet() throws Exception {
		...
		//
		token = new BasicSecurityToken("id1", null, null, null, null, null);
