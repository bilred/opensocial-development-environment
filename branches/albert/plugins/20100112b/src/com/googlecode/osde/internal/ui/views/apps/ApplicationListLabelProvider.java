...
class ApplicationListLabelProvider extends LabelProvider implements ITableLabelProvider {

    public Image getColumnImage(Object element, int columnIndex) {
        switch (columnIndex) {
            case 0:
                ImageDescriptor descriptor = Activator.getDefault().getImageRegistry()
                        .getDescriptor("icons/opensocial.gif");
    ...
    public String getColumnText(Object element, int columnIndex) {
        ApplicationImpl application = (ApplicationImpl)element;
        switch (columnIndex) {
            case 1:
