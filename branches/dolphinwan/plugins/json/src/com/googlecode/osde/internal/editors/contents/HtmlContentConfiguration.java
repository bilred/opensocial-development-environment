    ...
    public IPresentationReconciler getPresentationReconciler(ISourceViewer sourceViewer) {
        ...
        DefaultDamagerRepairer scriptDamageRepairer = new DefaultDamagerRepairer(
                new SingleTokenScanner(
                        new TextAttribute(activator.getColor(new RGB(0, 128, 150)))));
        ...
        DefaultDamagerRepairer htmlCommentDamageRepairer = new DefaultDamagerRepairer(
                new SingleTokenScanner(
                        new TextAttribute(activator.getColor(new RGB(100, 100, 100)))));
        reconciler.setDamager(htmlCommentDamageRepairer,
                HtmlContentPartitionScanner.TOKEN_HTML_COMMENT);
        reconciler.setRepairer(htmlCommentDamageRepairer,
                HtmlContentPartitionScanner.TOKEN_HTML_COMMENT);
        // tag part
